...
Beauty.UI.Places.Pulldown = Class.create({
    initialize: function ( hash ){
        ...
        else if( prm_sa.val ){ def_type = 'service_area' }
        // define post handler
        var _self = this;
        var process = function ( itm ){
            if( def_type == 'small_area' && itm ){
            ...
            }else if( def_type == 'middle_area' && itm ){
                prm_sa.val          = itm.service_area.code;
                prm_ma.service_area = itm.service_area.code;
                prm_sma.middle_area = prm_ma.val;
            }else if( def_type == 'service_area' ){
                prm_ma.service_area = prm_sa.val;
            }
            // create pulldown
