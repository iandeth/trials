...
sub gourmet_search {
	my $self = shift;
	$self->{api_url} = 'http://api.hotpepper.jp/GourmetSearch/V1/';
	my %params = @_;
...
sub large_service_area {
	my $self = shift;
	$self->{api_url} = 'http://api.hotpepper.jp/LargeServiceArea/V1/';
	return $self->_send_request(@_);
}

sub service_area {
	my $self = shift;
	$self->{api_url} = 'http://api.hotpepper.jp/ServiceArea/V1/';
	return $self->_send_request(@_);
}

sub large_area {
	my $self = shift;
	$self->{api_url} = 'http://api.hotpepper.jp/LargeArea/V1/';
	return $self->_send_request(@_);
}

sub middle_area {
	my $self = shift;
	$self->{api_url} = 'http://api.hotpepper.jp/MiddleArea/V1/';
	return $self->_send_request(@_);
}

sub small_area {
	my $self = shift;
	$self->{api_url} = 'http://api.hotpepper.jp/SmallArea/V1/';
	return $self->_send_request(@_);
}

sub genre {
	my $self = shift;
	$self->{api_url} = 'http://api.hotpepper.jp/Genre/V1/';
	return $self->_send_request(@_);
}

sub budget {
	my $self = shift;
	$self->{api_url} = 'http://api.hotpepper.jp/Budget/V1/';
	return $self->_send_request(@_);
}
